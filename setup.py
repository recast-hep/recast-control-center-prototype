...
setup(
  ...
  dependency_links = [
    ...
    # 'http://github.com/lukasheinrich/recast-dmhiggs-demo/tarball/master#egg=recast-dmhiggs-demo',
    # 'http://github.com/lukasheinrich/recast-rivet-recaster-demo/tarball/master#egg=recast-rivet-recaster-demo',
    # 'http://github.com/lukasheinrich/recast-hype-demo/tarball/master#egg=recast-hype-demo',
